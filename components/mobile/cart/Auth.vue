                ...
                <v-form  @submit.prevent="verifyOTP" ref="otpForm" class="w-100">
                    <div class="w-100 form-inner">
                        <div class="mt-3">
                            ...
                            <a @click="backStep1()" class="cur-p d-block back-step t13 w700 text-center text-primary darken-1 mb-8 mt-7">
                                <v-icon icon="mdi-pencil" color="primary" size="small"/>
                                ویرایش شماره همراه
                            </a>

                            <v-btn :loading="loading" color="primary" block rounded="xl" type="submit" height="50px" class="game-auth__btn">
                                تایید کد
                            </v-btn>
                        </div>

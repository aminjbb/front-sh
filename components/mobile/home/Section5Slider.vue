                ...
                <div
                    ...
                    <div class="section5-slider__sku-groups__inner">
                        ...
                        <div class="d-flex flex-wrap">
                            <a v-for="(item, skuIndex) in groups.skus?.slice(0, 4)" :key="`sku-${index}`" :id="`home-${screenId}-${content?.id}-${index}-${skuIndex}`" class="section5-slider__item" :href="`sku/${item.slug}`">

      ...
      <div
        ...
        <div class="stepper__header__content">
          ...
          <span class="t15 w400 pl-2"
                :class="active[index+1] ? 'text-primary': previousSteps[index+1] ? 'text-grey-darken-3' : 'text-grey'">{{ step }}</span>
        </div>
      ...
      <v-row v-if="activeStep !== 4">
        <v-col md="9">
          ...
          <template v-if="activeStep === 2">
            ...
            <generalNotification class="mb-3" borderColorCode="E91E63" color="pink" icon="mdi-alert-outline"
                                 text="کاربران عزیز، تمام سفارشات ثبت شده در بازه 1402/12/24 الی 1403/01/14، به ترتیب اولویت از 15 فروردین ارسال خواهد شد."/>
        ...
        <v-col md="3">
          ...
          <v-card class="py-5 px-3">
            ...
            <div v-if="data.sending_price !== 0 && data.sending_price !== null"

...
<footer class="game-footer w-100 d-flex flex-column align-center justify-center pb-5">
    ...
    <p class="mt-3 text-pink-lighten-4 t14 w500"> کلیه حقوق این سایت متعلق به فروشگاه اینترنتی شاواز می باشد</p>
</footer>
</template>

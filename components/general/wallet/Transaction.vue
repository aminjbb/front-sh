        ...
        <div class="d-flex align-center transactions__details">
            <div class="flex-grow-1 d-flex align-center justify-space-between pa-2 transactions__details__item">
                ...
                <div class="d-flex align-center">
                    <span v-if="details && details.charges" class="t14 number-font fw700 text-grey-darken-3 ml-1">{{ splitChar(Number(String(details.charges).slice(0, -1))) }}</span>
            ...
            <div class="flex-grow-1 d-flex align-center justify-space-between pa-2 transactions__details__item">
                ...
                <div class="d-flex align-center">
                    <span v-if="details && details.orders" class="t14 number-font fw700 text-grey-darken-3 ml-1">{{ splitChar(Number(String(details.orders).slice(0, -1))) }}</span>
                    <span class="t10 w400 text-grey-darken-3">تومان</span>
                </div>
            </div>
            ...
            <div class="flex-grow-1 d-flex align-center justify-space-between pa-2 transactions__details__item">
                ...
                <div class="d-flex align-center">
                    <span v-if="details && details.withdraw" class="t14 number-font fw700 text-grey-darken-3 ml-1">{{ splitChar(Number(String(details.withdraw).slice(0, -1))) }}</span>
                    <span class="t10 w400 text-grey-darken-3">تومان</span>
                </div>
            </div>
        </div>

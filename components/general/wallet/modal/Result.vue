...
export default {
    data() {
        return {
            ...
            formatContentMoc: [{
                ...
                {
                    label: 'زمان تراکنش',
                    value: '1402/09/20 - 12:33'
                },
                {
                    label: 'پرداخت از کارت',
                    value: 'توسعه تعاون - 8718'
                },
                {
                    label: 'کد رهگیری',
                    value: '20805557141702217918491'
                },
                {
                    label: 'شماره مرجع',
                    value: '7039298941702218041146'
                }
            ],
            decreaseContentMoc: [{
                    label: 'شماره کارت',
                    value: '5859 8310 6501 1131'
                },
                {
                    label: 'زمان درخواست',
                    value: '1402/09/20 - 12:33'
    ...
    props: {
        /**
         * content
         * *You should formate tour data in label and value*
         */
        content: Array,

<template>
    <v-bottom-sheet class="c-modal" v-if="sheet" v-model="sheet" color="white" height="auto">
                ...
                <div class="ticket__form">
                    <v-row>
                        ...
                        <v-col cols="12" class="ticket__form__item ">
                            ...
                            <generalUploader ref="imageUploader" @getImage="getImage" @deleteImage="deleteImage" :rules="uploadRules" :isMobile="isMobile === true ? true : false" />
                        </v-col>
                    </v-row>

                    <div class="ticket__form__btn d-flex justify-center w-100 mobile-pa-0 align-center">
                        <v-btn :loading="loading" @click="addAnswer()" prepend-icon="mdi-message-processing-outline" block height="44" title="تایید و ثبت" class="btn btn--submit br12">
                           {{ buttonText }}
                        </v-btn>
                    </div>
                </div>

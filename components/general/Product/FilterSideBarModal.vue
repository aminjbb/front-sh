                    ...
                    <template v-for="(filter, index) in filterList" :key="`filter${index}`">
                        ...
                        <div class="filter-sidebar__card filter-sidebar__card--mobile" :id="`filter-sidebar__card--${index}`">
                            ...
                            <template v-if="filter.type === 'select'">
                                <generalProductFilterSelects :index="index" @selectedFilter="addSelectedFilterForShowBadge" :ShowEnName="filter.param === 'categories' || filter.param === 'products' ? false : true" :items="filter.data" :clear="clearAll" :title="filter.label" :name="filter.label" :param="filter.param" @selectItems="selectFiltersModalEmit" @changeClearToFalse="changeClearToFalse" />
                            </template>

                            <template v-else-if="filter.type === 'switch'">
                                <generalProductFilterSwitch :index="index" @removeSelectedFilter="removeSelectedFilterForShowBadge" @selectedFilter="addSelectedFilterForShowBadge" @changeClearToFalse="changeClearToFalse"  @changeStatus="selectFiltersModalEmit" :title="filter.label" :clear="clearAll" :name="filter.label" :param="filter.param" :switchName="filter.value" />
                            </template>

                            <template v-else-if="filter.type === 'checkbox'">
                                <generalProductFilterSelects :index="index" @removeSelectedFilter="removeSelectedFilterForShowBadge" @selectedFilter="addSelectedFilterForShowBadge" :ShowEnName="filter.param === 'categories' || filter.param === 'products' ? false : true" @changeClearToFalse="changeClearToFalse" :items="filter.data" :title="filter.label" :name="filter.label" :param="filter.param" :clear="clearAll" @selectItems="selectFiltersModalEmit" />
                            </template>
                            ...
                            <template v-else-if="filter.type === 'period'">
                                <div class="filter-sidebar__card mt-3" :id="`filter-sidebar__card--${filterList.length}`">
                                    ...
                                    <div>
                                        <generalProductFilterSelectsMount :index="index" @removeSelectedFilter="removeSelectedFilterForShowBadge" @selectedFilter="addSelectedFilterForShowBadge" @changeClearToFalse="changeClearToFalse" @selectItems="setAmount" :isFilter="filter?.is_searchable" :items="filter?.data" :title="filter.name" :param="filter.param" :name="filter.name" />
                                    </div>
                                </div>
                            </template>
                        </div>

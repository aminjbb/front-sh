  ...
  <v-app>
    <div v-show="show">
      <div v-if="screenType === 'desktop'">
        ...
        <template
            v-if="$route.name !== 'campaign-romina' && $route.name !== 'login' && $route.name !== 'forgotPassword' && $route.name !== 'welcome' && $route.name !== 'game-slug'">
        ...
        <template v-if="$route.name === 'index'">
          <generalModalsLogin :signupStatus="!loginStatus" image="voucher-login.png" voucherImage="voucher-cart.svg"
      ...
      <div v-else-if="screenType === 'mobile'">
        ...
        <slot/>
        <template
            v-if="$route.name !== 'campaign-romina' && $route.name !== 'login' && $route.name !== 'forgotPassword' && $route.name !== 'welcome' && $route.name !== 'game-slug' && $route.name !== 'cart' ">

  ...
  <v-app>
    <div v-show="show">
      <div v-if="screenType === 'desktop'">
        ...
        <template
            v-if="$route.name !== 'login' && $route.name !== 'forgotPassword' && $route.name !== 'welcome' && $route.name !== 'game-slug'">
      ...
      <div v-else-if="screenType === 'mobile'">
        ...
        <slot/>
        <template
            v-if="$route.name !== 'login' && $route.name !== 'forgotPassword' && $route.name !== 'welcome' && $route.name !== 'game-slug' && $route.name !== 'cart' ">

...
export default function setup() {
    ...
    return {getBasket, loading ,addToBasket , deleteShpsBasket , calculateSendingPrice , createOrder,calculateVoucher,voucher,getTransactionData,transactionData,createFailedOrder, deleteVoucherFromBasket }
}

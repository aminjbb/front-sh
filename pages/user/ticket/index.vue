          ...
          <v-card class="pa-8 mobile-pa-0 v-ticket__card">
            <template v-if="ticketList && ticketList.data && ticketList.data.length">
              ...
              <div class="px-3" :class="screenType === 'desktop' ? 'pb-5' : ''">
                <GeneralTicketTab :class="screenType === 'desktop' ? 'pr-5' : ''"
                                  :scroll="screenType === 'desktop' ? true : false"
                                  :height="screenType === 'desktop' ? '500px' : 'auto'" :tabHeader="statusList"
                                  :items="categorizedTickets" showAll AllTitle="همه تیکت ها"
                                  componentName="generalTicketCard"/>
              </div>
              <div class="w-100 d-flex justify-center px-4">
                <v-btn
                    ...
                    color="primary"
                    prepend-icon="mdi-message-processing-outline"
                    class="btn btn--submit br12 mb-5 mx-5 px-7">
                  ثبت تیکت
                </v-btn>

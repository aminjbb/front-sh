                    ...
                    <div class="ticket__form" :class="isMobile === true ? 'px-3' : 'pt-8 px-6'">
                        ...
                        <v-form ref="ticket" v-model="valid">
                            <v-row class="ticket__form__1stRow w-100 ma-0">
                                ...
                                <div class="ticket__form__item ticket__form__item--text-field">
                                    <v-select label="انتخاب زیرموضوع" density="compact" variant="outlined" item-title="title" item-value="value" hide-details :items="subTitleList" v-model="form.subtitle" @update:model-value="selectSubTitle()" />
                                </div>
                                ...
                                <div cols="12" md="6" class="ticket__form__item ticket__form__item--text-field">
                                    <v-text-field density="compact" variant="outlined" :rules="mandatoryFields['seller_sku_id'] ? rule : ''" hide-details label="شناسه کالا" v-model="form.seller_sku_id" />
                                </div>
                        ...
                        <div class="d-flex justify-center w-100 mobile-pa-0 align-center mb-7 mt-5">
                            <v-btn :loading="loading" @click="validate()" prepend-icon="mdi-message-processing-outline" height="44" class="btn btn--submit px-5 br12" title="ثبت تیکت" :block="isMobile === true ? true : false">
                                ثبت تیکت
                            </v-btn>
                        </div>
                    </div>

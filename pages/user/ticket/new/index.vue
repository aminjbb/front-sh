            ...
            <div class="ticket__form" :class="isMobile === true ? 'px-3' : 'pt-8 px-6'">
              ...
              <v-form ref="ticket" v-model="valid">
                <v-row class="ticket__form__1stRow w-100 ma-0">
                  ...
                  <div class="ticket__form__item ticket__form__item--text-field">
                    <v-select label="انتخاب زیرموضوع" density="compact" variant="outlined" :rules="rule"
                              item-title="title" item-value="value" hide-details :items="subTitleList"
                              v-model="form.subtitle" @update:model-value="selectSubTitle()"/>
                  </div>
                  ...
                  <div cols="12" md="6" class="ticket__form__item ticket__form__item--text-field">
                    <v-text-field density="compact" variant="outlined" :rules="mandatoryFields['sku_id'] ? rule : ''"
                                  hide-details label="شناسه کالا" v-model="form.sku_id"/>
                  </div>

                  <div cols="12" md="6" class="ticket__form__item ticket__form__item--text-field">
                    <v-text-field density="compact" variant="outlined"
                                  :rules="mandatoryFields['order_number'] ? rule : ''" hide-details label="شماره سفارش"

              ...
              <nav class="user-commenting__tab ov-h mb-5">
                <ul class="d-flex align-center justify-space-between">
                  <li
                      ...
                      @click="changeTab(1)">
                    <img
                        :src="tabImage === 1 ? imageAddress('commenting1-active.png') : imageAddress('commenting1.png')"
                        class="ml-2" alt="shavaz" width="30" height="30" title="shavaz"/>
                  ...
                  <li
                      ...
                      @click="changeTab(2)">
                    <img
                        :src="tabImage === 2 ? imageAddress('commenting2-active.png') : imageAddress('commenting2.png')"
                        class="ml-2" alt="shavaz" width="30" height="30" title="shavaz"/>
                ...
                <div class="user-commenting__content" id="user-commenting__content--2">
                  ...
                  <template v-else>
                    <div class="d-flex align-center justify-center flex-column py-15 px-2">
                      <img src="~/assets/images/no-comment.jpg" class="ml-2 mt-10" alt="shavaz" width="168" height="86"
                           title="shavaz"/>

    ...
    <v-container>
      <v-row>
        ...
        <div class="col-9 pa-4 mobile-pa-0">
          <v-card class="py-5 mobile-pa-0 mobile-no-border d-flex flex-column">
            ...
            <div v-for="item in returnedOrderDetail.data" :key="item.id" class="px-5">
              ...
              <div class="v-order__action d-flex align-center justify-end mt-5">
                <div v-if="item && item.crm_status == 'reject'"
                     class="v-order--return__status v-order--return__status--reject d-flex align-center ml-3">
                  <v-icon
                ...
                <div v-if="item && item.crm_status == 'accept'"
                     class="v-order--return__status v-order--return__status--accept d-flex align-center ml-3">
                  <v-icon
                ...
                <div v-if="item && item.crm_status == 'waiting'"
                     class="v-order--return__status v-order--return__status--loading d-flex align-center ml-3">
                  <v-icon
                      icon="mdi-history"
          ...
          <v-card v-if="hasAccept"
                  class="py-5 mobile-pa-0 mobile-no-border d-flex flex-column">
            <header class="d-flex align-center justify-space-between mb-5 xs-hide px-5">
              <div class="d-flex align-center">

      ...
      <v-row>
        ...
        <div class="col-9 pa-4 mobile-pa-0">
          <v-card class="py-5 mobile-pa-0 mobile-no-border v-order__inner d-flex flex-column">
            ...
            <div class="px-5">
              <v-row v-if="userOrder?.snapp_transaction_id && userOrder?.snapp_transaction_id !== null"
                     class="order-details my-0">
                <v-col
                    cols="12"
                    sm="6"
                    lg="3"
                  ...
                  <span v-if="userOrder && userOrder.id"
                        class="t13 w400 text-grey-darken-3 number-font">{{ userOrder.order_number }}</span>
                </v-col>
                <v-col
                    cols="12"
                    sm="6"
              ...
              <v-row class="order-details my-0">
                ...
                <v-col
                  ...
                  <span v-else-if="userOrder?.sending_price == 0"
                        class="t13 w400 text-grey-darken-3 number-font">رایگان</span>
                </v-col>

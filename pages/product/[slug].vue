                    ...
                    <div class="filter-bg-mobile pa-3 w-100" id="filter-bg-mobile">
                        ...
                        <template v-if="screenType === 'mobile'">
                            <div class="d-flex align-center">
                                <generalProductFilterSideBarModal :filterLength="selectedFilterLength" class="ml-1" :filterList="productFilterSecondaryData" @listFiltersModal="listFiltersModal" @clearFilterQuery="clearFilterQuery" @selectFiltersModal="selectFiltersModal" @setAmount="selectByAmount" />

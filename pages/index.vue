    ...
    <div v-show="!loading">
      ...
      <div v-if="screenType === 'desktop'">
        ...
        <v-container class="pt-0">
          ...
          <generalTabSlider :items="responseDot(6)" class="tab-slider1 mb-0" limit="12" contentWidth="1080px"
          ...
          <generalTabSlider :items="responseDot(11)" class="tab-slider1 mb-8 mt-4" limit="12" contentWidth="1080px"
      ...
      <div v-if="screenType === 'mobile'">
        ...
        <generalTabSlider :items="responseDot(6)" class="tab-slider1 pr-4" limit="12" device="mobile"
        ...
        <generalTabSlider :items="responseDot(11)" class="tab-slider1 pr-4" limit="12" device="mobile"
                          :title="titleSection11" :componentProps="tabSlider1ComponentProps" mobileMode/>
...
export default {
  ...
  setup() {
    const title = ref('فروشگاه اینترنتی شاواز')
    const description = ref(' فروشگاه اینترنتی شاواز Shavaz.com| مقایسه و خرید آنلاین انواع لوازم آرایشی، بهداشتی، عطر با ضمانت اصالت کالا با پایین ترین قیمت - برای خرید کلیک کنید!')

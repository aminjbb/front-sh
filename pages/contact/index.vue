<template>
  <main class="v-contact">
    <v-container>
      ...
      <v-card class="pa-8 mobile-no-border">
        <div class="faq-box d-flex justify-center align-center">
          ...
          <div class="faq-box__content">
            ...
            <p class="ma-0 t13 w400 text-grey-darken-1">لطفا پیش از ثبت تیکت، ابتدا بخش <a href="/faq"
                                                                                           class="text-blue">سوالات
              متداول</a> را مطالعه نمایید.
            </p>
          </div>
        </div>
      </v-card>
            ...
            <v-form ref="contact" v-model="valid">
              <v-row>
                ...
                <v-col
                    ...
                    md="6"
                    class="contact__form__item contact__form__item--text-field">
                  <label class="d-block t14 text-grey-darken-3 mb-4">موضوع <span class="text-red-accent-4">*</span>
                  </label>
                  <desktopKitsSelectShSelect id="changeTitle"  key="changeTitle" :items="categoryTypes"
                                             @changeValue="changeValue" v-if="!isMobile"/>
                  <mobileKitsSelectShSelect v-else id="changeTitleMobile" key="changeTitleMobile"  :items="categoryTypes"
      ...
      <a class="v-contact__map" href="https://www.google.com/maps/?q=35.72814946987037,51.290000176638316"
         target="_blank">
  ...
  data() {
    return {
      ...
      categoryTypes: [{
        ...
        {
          title: 'انتقاد و شکایات',
          value: 'criticism'
        },
        {
          title: 'ارتباط با واحد بازرگانی',
          value: 'commercial'
        },
        {
          title: 'ارتباط با واحد دیجیتال مارکتینگ',
          value: 'digital_marketing'
        },
        {
          title: 'ارتباط با واحد پشتیبانی',
          value: 'support'
        },
        {
          title: 'سایر موضوعات',
    ...
    const structureData = [
      {
        ...
        "@type": "Corporation",
        "name": "ارتباط با شاواز",
        "url": "https://shavaz.com/contact",
        "id": "https://shavaz.com/contact",

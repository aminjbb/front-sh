...
<main class="v-product v-product--single">
    ...
    <v-container v-show="!loading">
        ...
        <v-row>
            <v-col class="pa-3" cols="12" lg="5">
                <generalProductSingleImageGallery :getPdpData="getPdpData" :wishlist="wishlist" :productSelectedSeller="productSelectedSeller" :items="skuImageGallery" :productCategory="skuCategory" :productDetail="productDetail" />
            </v-col>

            <v-col class="pa-3" cols="12" lg="7">
                ...
                <template v-if="screenType !== null && screenType === 'desktop'">
                    <v-row class="v-product--single__border ma-0 px-1 mt-5">
                        ...
                        <v-col md="5" lg="4">
                            ...
                            <generalAddToBasket :content="productSelectedSeller" :productDetails="productDetail" :productCategory="skuCategory" />
                        </v-col>
                    </v-row>
                </template>
        ...
        <mobileHomeSection8Slider v-if="relatedProducts?.length" class="mt-5 pb-3" :items="relatedProducts" title="محصولات مشابه" hideIndex isPLP navigation />

        <generalProductSingleCompleteDetails :description="pdpSecondaryData?.story" :attrs="pdpSecondaryData?.specifics" :instructions="pdpSecondaryData?.how_to_use" :advantages="pdpSecondaryData?.advantage" :disadvantages="pdpSecondaryData?.disadvantage" :userUse="pdpSecondaryData?.uses_case" />
        ...
        <template v-if="screenType !== null && screenType === 'mobile'">
            <div class="mobile-basket" v-if="productSelectedSeller">
                <generalAddToBasket :content="productSelectedSeller" :productCategory="skuCategory" :productDetails="productDetail" revers="revers" :isPdp="true" :mdCols="['6','6']" :smCols="['4','8']" />
            </div>
        </template>
            ...
            window.dataLayer.push({
                ...
                ecommerce: {
                    items: [{ // an array where all currently viewed products must be included
                        ...
                        item_category: this.skuCategory, // insert an actual product top-level category

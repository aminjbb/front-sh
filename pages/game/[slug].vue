            ...
            <v-row v-if="screenType === 'desktop'" class="h-100">
                ...
                <v-col cols="12" class="d-flex justify-center v-game__lucky-wheel">
                    <div class="d-flex flex-column align-center" v-if="luckyWheel.length">
                        <generalGameFortuneWheel :token="token" ref="generalGameFortuneWheel" @updateForm="updateList" @luckyBtnClicked="openLoginModal" :items="luckyWheel" :isLogin="isLogin" :limit="turnPerUser" :userUsed="voucherList?.length" />
                    </div>
                </v-col>
